 ...
 * os menus do BatalhaNavalES. Todos os métodos são estáticos (static).
 *
...
public class BattleshipMenuUI {
    ...
    /**
     * Getter da variável booleana de flag de todas as estruturas de repetição
     * dos menus.
     *
    ...
    /**
     * Setter da variável booleana de flag de todas as estruturas de repetição
     * dos menus.
     *
    ...
    /**
     * Primeiro menu da sequência de menus do Batalha Naval. É feita a interação
     * do usuário para escolher o modo do jogo desejado.
     *
     * @return uma interface de modo de jogo instanciada de acordo com a entrada
     * do usuário.
    ...
    /**
     * Segundo menu da sequência de menus do Batalha Naval. É feita a interação
     * do usuário para escolher a dificuldade do jogo (tamanho do tabuleiro)
     * desejado.
     *
     * @return uma interface de dificuldade do jogo instanciada de acordo com a
     * entrada do usuário.
     * @see BattleshipMenuUI#menuBattleship()
     */
    ...
    /**
     * Último menu da sequência de menus do Batalha Naval. É feita a interação
     * do usuário para escolher o modo de distribuição de embarcações desejado.
     *
     * @return uma interface de modo de distribuição instanciada de acordo com a
     * entrada do usuário.
     * @see BattleshipMenuUI#menuBattleship()
     */
    ...
    /**
     * Exibe um texto sinalizando o fim do programa por opção do usuário antes
     * do começo do jogo.
     *
