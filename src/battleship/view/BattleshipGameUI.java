...
public class BattleshipGameUI {
     ...
     * É feita a interação do usuário para escolher a posição do tabuleiro onde
     * o usuário deseja "lançar" uma bomba (independentemente do tipo) no turno
     * atual do Batalha Naval.
     *
     * @return um objeto do tipo Posicao contendo a linha e coluna especificada
     * pelo usuário onde é esperada ter uma embarcação
     */
